      ...
      <div className="text-primary bg-light mt-6 overflow-x-auto rounded-md border border-gray-50">
        <div className="flex justify-between gap-2 px-4 py-5">
          <div className="flex items-center gap-3">
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#00000013] md:h-10.5 md:w-10.5">
              <i className="ri-user-fill text-[0.9rem] text-[#0000001f] md:text-[1.3rem]"></i>
            </span>
            <div className="leading-5">
              <h1 className="abril text-[0.9rem] md:text-[1.1rem] text-secondary">
                Michelle Rivera
        ...
        <p className="alegreya px-12 pt-4 pb-56 text-[0.9rem] md:text-[1.2rem]">
